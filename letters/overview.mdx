...
### Key Features:
- **Templates**: Build personalised templates to train Letters to match your tone and structure.
- **Sources**: Upload content to include in your letter, such as documents, transcriptions, or notes.
...
- **Version History**: Track and revert changes easily.
- **Request Edits**: Quickly request modifications to generated letters.