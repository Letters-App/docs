...
<Steps>
  ...
  <Step title="Sources">
    <Note />Sources can include quick dictate, text, files and transcriptions. Once you have added your sources you can click on them to rename or view.
  ...
  <Step title="Letter Outputs">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Exporting Your Letter" icon="paper-plane">
        ...
        **Copy to word** allows Word to detect and format pasted content automatically. **Email to** forwards your letter to the specified recipients. &#x20;
