...
* **Documents Processing**: Documents and files you upload into Letters are processed on Australian servers by LLM models immediately upon upload. These models strip non-relevant text, and only the resulting output is stored. Similar to audio, your original file is hard-deleted immediately following processing.
